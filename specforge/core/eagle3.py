...
class QwenVLOnlineEagle3Model(Eagle3Model):
    ...
    def _prepare_data(
        ...
        outputs = self.target_model.model(**filtered_target_kwargs)
        ...
        offset = 1
        hidden_states0 = outputs.hidden_states[self.target_model.aux_hidden_states_layers[0] + offset]
        hidden_states1 = outputs.hidden_states[self.target_model.aux_hidden_states_layers[1] + offset]
        hidden_states2 = outputs.hidden_states[self.target_model.aux_hidden_states_layers[2] + offset]
