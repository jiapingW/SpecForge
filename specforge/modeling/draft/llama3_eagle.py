...
from specforge.distributed import get_draft_tp_group
from specforge.layers.linear import ColumnParallelLinear, RowParallelLinear, _AllReduce

from ...distributed import get_draft_sp_ring_group, get_draft_sp_ulysses_group
...
class LlamaUSPFlashAttention(LlamaAttention):
    ...
    def __init__(self, config):
        ...
        self.ring_pg = get_draft_sp_ring_group()
        self.ulysses_pg = get_draft_sp_ulysses_group()
